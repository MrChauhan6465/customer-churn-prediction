...
Key patterns observed during EDA included higher churn among:
...
Receives customer information as JSON.
Performs the required feature engineering.
Applies the saved preprocessing object.
Generates the churn probability.
Applies the 0.40 classification threshold.
